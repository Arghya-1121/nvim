...
-- New keybinds for splitting windows
vim.keymap.set('n', '<C-1>', '<cmd>vsplit<CR>', { desc = 'Split window vertically' })
vim.keymap.set('n', '<C-2>', '<cmd>split<CR>', { desc = 'Split window horizontally' })
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>g', group = 'Git [G]it', mode = { 'n', 'v' } },
      },
    },
  },
